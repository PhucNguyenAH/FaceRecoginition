...
class HumanDetector(object):
    def __init__(self, **kwargs):
        ...
        # dataset
        detect_model_name = os.path.join(PYTHON_PATH, 'ailibs_data', 'humanDetection', 'ssd_mobilenet_v1_coco_2017_11_17')
    ...
    def get_localization(self, image, visual=False):  
        ...
        with self.detection_graph.as_default():
              ...
              if len(idx_vec) ==0:
                  ...
                  self.human_boxes = tmp_human_boxes
